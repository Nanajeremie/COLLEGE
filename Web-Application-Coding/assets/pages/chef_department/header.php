...
<div id="wrapper">
    ...
    <div id="fixeSideBar">
        ...
        <div id="fixeHeight" class="comment-scrollbar">
            ...
            <!-- Divider -->
            <h4 class="sidebar-heading mt-3">Interview Management</h4>
            <hr class="sidebar-divider">
            <!-- Nav Item - Meetings -->
            <?php menu_item_collapse('Manage-Interview', '#', 'fas fa-handshake', ['allmeeting.php', 'all_plan_meeting.php'], ['Start Interview', 'Interviews List']); ?>

            
            <!-- Divider -->
            <h4 class="sidebar-heading mt-3">Teachers Management</h4>
            <hr class="sidebar-divider">
            <!-- Nav Item - Scholarship -->
            <?php menu_item_collapse('Manage-Teachers', '#', 'fas fa-chalkboard-teacher', ['add_teacher.php', 'edit_teacher.php'], ['Add Teacher', 'Edit Teachers']); ?>
            
            <!-- Divider -->
            <h4 class="sidebar-heading mt-3">Tests Management</h4>
            <hr class="sidebar-divider">

            <?php menu_item_collapse('Manage-Tests', '#', 'fas fa-chalkboard', ['planned_test.php' , 'admin_mark_reports.php', 'averages.php'], ['Planned Test' , 'Marks', 'Generate Averages']); ?>
